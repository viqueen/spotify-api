...
func (a *ShowsAPIService) GetAShowsEpisodesExecute(r ApiGetAShowsEpisodesRequest) (*PagingSimplifiedEpisodeObject, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (a *ShowsAPIService) GetUsersSavedShowsExecute(r ApiGetUsersSavedShowsRequest) (*PagingSavedShowObject, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
